        ...
        stage('Build and Deploy Docker') {
            ...
            steps {
                script {
                    ...
                    def ncpAuthCommand = "${IAM_AUTHENTICATOR_PATH} token --clusterUuid 453f1927-60c9-4579-b22c-5338336c32ce --region KR --credentialConfig /var/lib/jenkins/.kube/config"
